...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/yoyo-migrations-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12851&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/yoyo-migrations-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `yoyo-migrations` can be installed with:

```
conda install yoyo-migrations
```

It is possible to list all of the versions of `yoyo-migrations` available on your platform with:
